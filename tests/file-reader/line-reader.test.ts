...
describe('LineReader', () => {
    describe('prev_char', () => {
        it(`shouldn't change index if current char is the first one`, () => {
            const parser = new LineReader('text', 0);
            parser.prev_char();
        ...
        it(`should return empty char if current char is the first one`, () => {
            expect(new LineReader('text', 0).prev_char().is_empty()).to.true;
        })

        it('should decrement index', () => {
            const parser = new LineReader('text', 3);
            parser.prev_char();
    ...
    describe('next_char', () => {
        ...
        it(`should return empty char if current char is the last one`, () => {
            expect(new LineReader('text', 3).next_char().is_empty()).to.true;
        })
    ...
    describe('prev_word', () => {
        ...
        it(`should load previous word`, () => {
            const parser = new LineReader('one two', 4);        
            expect(parser.prev_word().get()).is.eql("one");
        })
        
        it(`should change index and selected char`, () => {
            const parser = new LineReader('one two three', 9);        
    ...
    describe('next_word', () => {
        it(`should return empty word if the current one is the last one`, () => {
            const parser = new LineReader('one two', 6);
        ...
        it(`should change index and selected char`, () => {
            const parser = new LineReader('one two three', 1);        
    ...
    describe('skip_white_space', () => {
        it(`should skip white space`, () => {
            const parser = new LineReader('one  \n  two', 3);
        ...
        it(`should do nothing if selected char is not a wait space character`, () => {
            const parser = new LineReader('one two', 1);
            parser.skip_white_space();
        ...
        it(`should do nothing if selected char is the last character`, () => {
            const parser = new LineReader('one two\n', 7);
            parser.skip_white_space();
    ...
    describe('skip_white_space_backward', () => {
        ...
        it(`should do nothing if selected char is not a wait space character`, () => {
            const parser = new LineReader('one two', 5);
            parser.skip_white_space_backward();
    ...
    describe('skip_space', () => {
        ...
        it(`should do nothing if selected char is the last character`, () => {
            const parser = new LineReader('one two ', 7);
            parser.skip_space();
    ...
    describe(`skip_until`, () => {
        it(`should skip characters until function return true`, () => {
            const parser = new LineReader('123123123123123123123e', 1);
        ...
        it(`should do nothing if function return false for current character`, () => {
            const parser = new LineReader('e123123123123123123123e', 0);
            parser.skip_until(char=>char.is_number());
    ...
    describe(`skip_left_until`, () => {
        it(`should skip characters backward until function return true`, () => {
            const parser = new LineReader('e123123123123123123123', 21);
        ...
        it(`should do nothing if function return false for current character`, () => {
            const parser = new LineReader('e12312312312312312312e', 21);
            parser.skip_left_until(char=>char.is_number());
    ...
    describe(`jump_to`, () => {
        it(`should set index to the first matching character`, () => {
            const parser = new LineReader('1231231e23123123123123e', 0);
            parser.jump_to('e');
        ...
        it(`should skip all characters if the chose one not exist`, () => {
            const parser = new LineReader('0123456789', 0);
            parser.jump_to('e');
    ...
    describe(`jump_to_word_start`, () => {
        it(`should do nothing if the selected char is a wait space`, () => {
            const parser = new LineReader('one two three', 3);
        ...
        it(`should jump to the first letter of the selected word`, () => {
            const parser = new LineReader('one two three', 5);
            parser.jump_to_word_start();
    ...
    describe('is_eof', () => {
        it(`should return true if the selected char is the last one`, () => {
            expect(new LineReader('0123456789', 9).is_eof()).to.be.true;
        })

        it(`should return false if the selected char isn't the last one character`, () => {
            expect(new LineReader('0123456789', 3).is_eof()).to.be.false;
        })
    })
    ...
    describe(`read_char`, () => {
        it(`shouldn't change index`, () => {
            const parser = new LineReader('test', 2);
            parser.read_char();
    ...
    describe('read_prev_char', () => {
        ...
        it(`should return empty char if current char is the first one`, () => {
            expect(new LineReader('text', 0).read_prev_char().is_empty()).to.true;
        })
    ...
    describe('read_next_char', () => {
        ...
        it(`should return empty char if current char is the first one`, () => {
            expect(new LineReader('text', 3).read_next_char().is_empty()).to.true;
        })
    ...
    describe(`read_until`, () => {
        it(`shouldn't change index`, () => {
            const parser = new LineReader('123123123123123123123e', 2);
        ...
        it(`should read characters until function return true`, () => {
            const parser = new LineReader('123123123123123123123e', 0);
    ...
    describe('get_text', () => {
        it(`should return the text that is currently loaded into parser`, () => {
            const parser = new LineReader('0123\n45\n 67sad e89', 0);
